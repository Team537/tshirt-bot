...
public class DriveIOFalcon500 implements DriveIO {
  ...
  public DriveIOFalcon500() {
    leftLeader = new TalonFX(DriveConstants.kFrontLeft);
    rightLeader = new TalonFX(DriveConstants.kFrontRight);
    leftFollower = new TalonFX(DriveConstants.kRearLeft);
    rightFollower = new TalonFX(DriveConstants.kRearRight);
